...
export default class LoginFill extends Vue {
  public activeName = "ToLogin";
  public numberValidateForm = {
    username: "admin",
    password: "123456"
  };
  private checked = true;

  public handleClick(tab: object, event: object) {
  ...
  public submitForm(formName: string) {
    ...
    form.validate((valid: boolean) => {
      if (valid) {
        const { username, password } = this.numberValidateForm;
