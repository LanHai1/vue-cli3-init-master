export default {
     ...
     * @returns {Date}
     */
    parseStrToDate(dateStr: any, pattern: any) {
     ...
     * @returns {*}
     */
    formatDate(dat: any, parttern: any) {
     ...
     * @returns {Array}
     */
    getDates(startDate: any, stopDate: any, parttern?: any) {
        if (!parttern || parttern === '') parttern = 'yyyy-MM-dd'
        let dateArray = []
     ...
     * @returns {Number}
     */
    getDays(startDate: any, stopDate: any, parttern: any) {
        if (!parttern || parttern === '') parttern = 'yyyy-MM-dd'
     ...
     * @returns {*}
     */
    addDate(strDate: any, days: any, parttern: any) {
